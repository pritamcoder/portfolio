            ...
            <div className='h-[85%] flex flex-col-reverse  md:flex-row' >
                ...
                <div className='contactform flex items-center justify-center  md:w-2/4 w-full px-3'>
                    <form className='flex flex-col gap-5 bg-slate-950 py-10 lg:px-10 px-5 rounded-lg '>
                        ...
                        <textarea name="" id="comment" className='w-80 h-40 rounded-md px-2 bg-slate-900' placeholder='comment' required />
                ...
                <div className='contactcnvs md:w-1/2 h-full max-md:h-[80vh]'>
